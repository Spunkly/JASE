...
public class ExampleTester {
	...
	public void init() throws Exception {
		/* start server */
		javaServer = new HttpServiceServer(JAVA_PORT, "testrsc/conf/operations.conf", "testrsc/conf/types.conf");
	...
	public void testSciKit() throws Exception {
		...
		ServiceCompositionResult constructCall = client.callServiceOperation("127.0.0.1:" + JAVA_PORT + "/" + "SVC" + "::__construct");
	...
	public void testClassifier() throws Exception {
		...
		String serviceId = client
				.callServiceOperation("127.0.0.1:" + JAVA_PORT + "/" + c.getClass().getName() + "::__construct")
				.get("out").asText();
		client.callServiceOperation(serviceId + "::buildClassifier", split.get(0));
